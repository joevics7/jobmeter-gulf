...
export default function ExitIntentPopup() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      if (now - storedTime < SEVEN_DAYS_MS) {
        return;
      }
    }
        ...
        <div className="px-6 pb-6 -mt-8 relative">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-5">
            <p className="text-gray-600 text-center mb-5 text-sm">
              Join <span className="font-semibold text-blue-600">5,000+</span> job seekers getting daily job updates directly on their phone!
            </p>

              <div className="space-y-3">
              <a 
                href="https://whatsapp.com/channel/0029VbCym2i7DAWx9oGcIV11"
                target="_blank"
                rel="noopener noreferrer"
                onClick={handleSocialClick}
                className="flex items-center justify-between gap-3 w-full px-4 py-3.5 bg-green-500 text-white rounded-xl font-semibold hover:bg-green-600 transition-all hover:shadow-lg hover:scale-[1.02] group"
              >
              ...
              <a 
                href="https://t.me/+dxmM9_THQnY3Y2M0"
                target="_blank"
                rel="noopener noreferrer"
                onClick={handleSocialClick}
                className="flex items-center justify-between gap-3 w-full px-4 py-3.5 bg-[#0088cc] text-white rounded-xl font-semibold hover:bg-[#0077b3] transition-all hover:shadow-lg hover:scale-[1.02] group"
              >
                <div className="flex items-center gap-3">
