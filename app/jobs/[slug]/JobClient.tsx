...
const STORAGE_KEYS = {
  SAVED_JOBS: 'gulf_saved_jobs',
  APPLIED_JOBS: 'gulf_applied_jobs',
};

// ─── Worker URL for similar/related jobs (client-side fallback) ───────────────
// Replace with the Gulf-specific worker URL when ready.
const SIMILAR_JOBS_WORKER_URL = 'https://jobs-api-gulf.joevicspro.workers.dev/jobs';
...
const ALL_BLOGS = [
  ...
  // ─── Add new Gulf-relevant blog URLs below ───────────────────────────────────
];

// ─── Gulf countries — these route to internal /jobs pages (same domain) ───────
const GULF_COUNTRIES_SET = new Set([
...
function isGulfJob(job: any): boolean {
  ...
  return candidates.some(c => GULF_COUNTRIES_SET.has(c));
}
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pt-[96px] pb-[110px] lg:pb-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* No "Apply for Me" on gulf.jobmeter.app */}
        ...
        {/* No TimedJobPopup on gulf.jobmeter.app */}
