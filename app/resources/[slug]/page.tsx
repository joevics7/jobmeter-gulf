...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  const url = `https://gulf.jobmeter.app/resources/${page.slug}`;
...
export default async function CategoryPage({ params }: { params: { slug: string } }) {
  ...
  const jsonLd = {
    ...
    name: page.h1_title,
    description: page.meta_description,
    url: `https://gulf.jobmeter.app/resources/${page.slug}`,
    mainEntity: {
      '@type': 'ItemList',
      name: page.h1_title,
      description: page.meta_description,
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Categories', item: 'https://gulf.jobmeter.app/resources' },
        { '@type': 'ListItem', position: 3, name: page.h1_title, item: `https://gulf.jobmeter.app/resources/${page.slug}` },
      ],
    },
  };
